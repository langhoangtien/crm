...
{
		jQuery('body').on('click', '#select_all, #sortable_table tbody :checkbox',checkbox_click);
}
...
{
	if(typeof tableHTML_ ==='undefined') {tableHTML = '#sortable_table';} else{ tableHTML = tableHTML_;}
