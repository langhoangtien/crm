	...
	$( document ).ready(function() {
        ...
        // enable autocomplete
        var frame_array = ['customer_list', 'xem_list','join_list', 'implement_list', 'trangthai_list','create_task_list', 'pheduyet_task_list', 'progress_list'];
        ...
        function startSearch () {
            load_task(get_current_page(), 'clearAll');
        }
        ...
        $('body').on('change','#search_date_type',function(){
            ...
            switch(value) {
                case 'today':
                    ...
                    s_date_start_from.val(current_date + ' 00:00');
                ...
                case 'weekend':
                    ...
                    s_date_start_from.val(firstDay + ' 00:00');
...
//				return false;
    ...
    function get_current_page() {
        var page = 1;
        if ($('.pagination-top').size() > 0) {
            page = parseInt($('.pagination-top:first-child strong').text());
        }
        if (page <= 0) {
            page = 1;
        }
		...
		$.ajax({
			...
			success: function(string){
			   ...
			   gantt.config.columns = [
			 				          ...
			 				          {name:"days", label: "Số ngày", width: 100, align: "center"},
                ...
                if (typeof selected_task_id != 'undefined') {
                    gantt.selectTask(selected_task_id);
                }
