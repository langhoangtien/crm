...
class Attributes extends Secure_area implements Idata_controller
{
    ...
    */
    ...
    /* 
    * Check if attribute code existed
    * @return void
    */
    public function check_existing_code()
    {
        $code = $this->input->post("code");
      
        if (count($this->Attribute->get_attribute_by_code($code))>0) {
            echo json_encode(array("flag"=>false, "message"=>lang('attribite_code_existed')));
        }
        else {
             echo json_encode(array("flag"=>true, "message"=>''));
        }
