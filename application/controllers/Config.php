...
class Config extends Secure_area 
{
	...
	{	
        ...
        $data['ecommerce_cron_sync_operations'] = [];
        ...
        'value' => isset($_POST['return_policy']) ? $_POST['return_policy'] : '',
        #Optionnal values
        'config' => array(
        ...
        if (!empty($this->config->item('ecommerce_cron_sync_operations'))) {
        	$data['ecommerce_cron_sync_operations'] = json_decode($this->config->item('ecommerce_cron_sync_operations'));
        }
