...
{
	public function delete($item_id,$location_id){
		$this->db->delete('inventory', array('location_id' => $location_id,'bat_dau' => 1,'trans_items' => $item_id));
	}
