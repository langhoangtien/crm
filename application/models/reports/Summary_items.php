...
class Summary_items extends Report
{
	...
	{		
		...
		$columns[] = array('data'=>lang('reports_quantity_current'), 'align'=> 'left');
		$columns[] = array('data'=>lang('reports_quantity_purchased'), 'align'=> 'left');
		$columns[] = array('data'=>lang('reports_subtotal'), 'align'=> 'right');
		$columns[] = array('data'=>lang('reports_total_tax_included'), 'align'=> 'right');
	...
	public function getData()
	{
		...
		//If we are NOT exporting to excel make sure to use offset and limit
	...
	public function getSummaryData()
	{
		...
		foreach($this->db->get()->result_array() as $row)
		{
			...
			$return['total_tax_included'] += to_currency_no_money($row['total'],2);
