					...
					<div class="col-sm-9 col-md-3 col-lg-3">
						<div class="input-group">
							<span class="input-group-addon bg">
	                       	...
	                       	<?php echo form_input(array('name'=>'date','value'=>date('d-m-Y H:i:s', strtotime($sale_info['sale_time'])), 'id'=>'date', 'class'=>'form-control'));?>
						</div>
					</div>
				</div>
		...
		<div class="panel-body">
			<?php echo form_open("sales/save/".$sale_info['sale_id'],array('id'=>'sales_edit_form','class'=>'form-horizontal')); ?>
				...
				<div class="form-group">	
					<?php echo form_label(lang('common_employee').' :', 'employee',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
					<div class="col-sm-9 col-md-3 col-lg-3 sale-s">
						<?php echo form_dropdown('employee_id', $employees, $sale_info['employee_id'],'disabled id="employee_id" class="span3"');?>
					</div>
				</div>
...
<script type="text/javascript" language="javascript">
	...
	{	
		...
		date_time_picker_field($('#date'), 'DD-MM-YYYY HH:mm:ss');
