		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
					...
					<div class="col-md-6">
                        ...
                        <?php
                        $cost_label = (!empty($category)) ? $category['name'] : 'Chi phí';
                        ?>
						<ul class="list-group close-amount">
						  ...
						  <li class="list-group-item active"><?php echo sprintf(lang('sales_closing_amount_approx'), ''); ?> <span class="pull-right text-success total-amount"><?php echo to_currency($closeout); ?></span></li>
							<li class="list-group-item"><?php echo $cost_label; ?>:  <input id="other_amount" style="border: 1px solid #d7dce5; border-radius: 1px;" class="pull-right" type="text"/></li>
						</ul>
					...
					<div class="row">
						<div class="col-md-12">
											...
											<div style="text-align: center;">
                                                ...
                                                <input type="hidden" name="other_amount" value="0" />
...
$(document).ready(function(e)
{
	...
	$("#other_amount").change(function (e) {
        ...
        $('[name="other_amount"]').val(parseInt($(this).val()));
...
{
    var closeout = <?php echo $closeout; ?>;
    var other_amount = $('[name="other_amount"]').val();
    closeout     = parseInt(closeout);
    other_amount = parseInt(other_amount);
    var total = closeout - other_amount;

	if($('#closing_amount').val()== total || $('#closing_amount').val()== total)
		{
