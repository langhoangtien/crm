	...
	<div class="col-md-12">
		...
		<div class="panel">
			<div class="panel-body">
                ...
                <div class="form-group">
                    <?php echo form_label('Tách gói khi bán hàng :', '',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php echo form_checkbox(array(
                            ...
                            'class' => 'delete-checkbox',
                            'value'=>1,
                            'checked'=>(boolean)(($item_kit_info->peel))));
                        ?>
                        <label for="peel_label"><span></span></label>
                    </div>
                </div>
