...
<div class="panel-heading">
	...
	<a href="javascript:;" >/ Báo cáo doanh thu</a>
	<div class="pull-right">
		<form action="<?php echo base_url().'reports/export_revenue_word'; ?>" method="post">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-piluku">
			<h3 class="text-center">Báo cáo dự báo doanh thu sẽ ghi nhận thêm</h3>
	...
	function xuat_bao_cao(){
		...
		if (date_start !='' && date_end !='') {
			if (parseInt(s.getTime()) > parseInt(e.getTime())) {
				toastr.error('Bạn đã nhập sai thời gian');
				$('#export-btn').fadeOut();
			}else{
				...
				$('#export-btn').fadeIn();
				$.ajax({
					url: "<?php echo base_url().'reports/export_revenue_data'?>",
					type: 'POST',
					dataType: 'html',
