...
<div class="modal-dialog mogal-lg">
	<div class="modal-content customer-recent-sales">
		...
		<h4 style="width:89%; float:left;"><?php echo lang('lich_su_gui_mail'); ?></h4>
		...
		<table>
			...
			<?php foreach ($data as $key => $row) { ?>
				...
				<tr>
				<td></td>
				<td><a class="btn btn-primary btn-lg" href="application/excel_materials/<?php echo $row->file; ?>">Tải file</a>
				</td>
				</tr>
			<?php } ?>
			</tbody>
