<?php
    ...
    if(!empty($items)) {
        ...
        foreach($items as $val) {
            ...
            $profit_before_charging_commission = $val['order_value'] + $val['thu_value'] - $val['chi_value'] - $val['cost_value'] - $val['point_payment'] - $val['gift_card_payment'];
            $profit_before_charging_commission = to_currency($profit_before_charging_commission);
...
?>
            <tr data-tree="<?php echo $sale_id; ?>">
                ...
                <td class="right"><?php echo $profit_before_charging_commission; ?></td>
                <td class="right"><?php echo $profit; ?></td>
                <td class="right"><?php echo $specific_commission; ?></td>
