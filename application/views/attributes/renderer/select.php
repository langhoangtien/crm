...
<?php endif; ?>
<select id = "<?php echo $attribute->code ?>" class ="attribute-input attribute-select" class="form-control <?php if (!empty($attribute->required) && $attribute->required == Attribute::YES) :?>required<?php endif; ?>" name="attributes[<?php echo $attribute->id; ?>]">
