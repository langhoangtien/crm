                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="cl">
                                     ...
                                     <label style ="font-weight: normal; color: red;" id = "attribute_code_input_error" ></label>                                                                                                                                 
                                </div>
                                <div class="col-md-4">
    ...
    $('#attribute_code').keyup(function(){
		...
		if(this.value.length >=0) {
			...
			timer = setTimeout(function(){
				$.ajax({
					url: 'attributes/check_existing_code',
					type: 'POST',
					data:{code: $('#attribute_code').val()},
					success:function (data){
                        if(JSON.parse(data)['flag']) {
                            submitting = false;
                            $('#attribute_code_input_error').html(JSON.parse(data)['message']);
                        }
                        else
                        {
                            submitting = true;
