		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
                ...
                <ul class="list-inline">
                    <li>
                        <a class="btn green btn-sm" href="<?php echo site_url('customers/excel'); ?>"><?php echo lang('customers_new_customers_import'); ?></a>
                    </li>
                    <li>
                        <?php echo lang('common_or');?>
                    </li>
                    <li>
                        <a class="btn yellow-gold btn-sm" href="<?php echo site_url('customers/excel_export'); ?>"><?php echo lang('customers_update_customers_import'); ?></a>
                    </li>
                </ul>
...
<script type='text/javascript'>
	$(":file").filestyle({buttonName: "btn-sm yellow-casablanca"});
...
<div class="col-md-12 text-center" style="margin-top: 30px;">
	<strong><a href="/#" target="_blank"><?php echo lang('customers_adding_location_requires_addtional_license'); ?></a></strong>
</div>
<?php }?>
