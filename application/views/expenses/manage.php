...
?>
                        ...
                        <span class="item-tabs">
                            <a href="<?php echo base_url() . 'expenses/shift/';?>"><?php echo $category['name']; ?></a>
                        </span>
                        <span title="total customers" class="badge bg-primary tip-left"><?php echo $count_shift; ?></span>
<?php
    }
?>
