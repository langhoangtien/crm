		...
		<div class="col-md-9">	
			<div class="buttons-list">
				<div class="pull-right-btn">
					<a href="<?php echo site_url('messages'); ?>" id="new-person-btn" class="btn btn-success btn-lg"><span class=""><?php echo lang('messages_inbox') ?></span>
						<?php if (($number_message_to>0)) { ?> 
							<span class="badge info-number <?php echo $number_message_to > 0 ? 'bell': '';?>" style="margin: -1px; background: #fb5d5d; color: white;"><?php echo $number_message_to; ?></span>
						<?php } ?>
					</a>
