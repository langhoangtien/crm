            ...
            <div class="front">
                ...
                <div class="holder">
                    ...
                    <?php echo form_open('login', array('class' => 'form login-form', 'id'=>'loginform', 'autocomplete'=> 'off')) ?>            
                        ...
                        <?php if (validation_errors() || !empty($captcha_error)) {?>
                        <div class="alert alert-danger">
                            <strong><?php echo lang('common_error'); ?></strong>
                            <?php echo validation_errors(); ?>
                            <div><?php echo $captcha_error; ?></div>
                        </div>
                        <?php } ?>
                        ...
                        <?php echo form_password(array(
                            ...
                            'size'=>'20')); 
                        ?>
                        <input type="hidden" name="secret" value="<?php echo GOOGLE_RECAPTCHA_SECRET_KEY ;?>" />
                        <div class="form-group" style="margin-top: 20px;">
                            <div class="g-recaptcha" data-sitekey="6Ldsn5MUAAAAANfOk9FS4z2JHf4UOOQqbuLP5-vc"></div>
                        </div>
                        <div class="bottom_info hidden">
                    ...
                    <div class="version">
                        <p>
                            <span class="badge bg-success"><?php echo APPLICATION_VERSION; ?></span> <?php echo lang('common_built_on'). ' '.date('d/m/Y'. ' '.get_time_format(), BUILD_TIMESTAMP);?>
                        </p>
