...
<div class="manage_buttons">
    <div class="manage-row-options hidden">
        <div class="email_buttons groups">
            <?php if ($this->Employee->has_module_permission($controller_name, $this->Employee->get_logged_in_employee_info()->person_id)) :?>
            <?php echo anchor("$controller_name/delete",
                              '<span class="">' . lang("common_delete") . '</span>',
                              array('id' => 'delete', 'class' => 'btn btn-red btn-primary disabled', 'title' => lang("common_delete")));
            ?>
            <?php endif; ?>
            ...
            <div class="buttons-list groups-buttons">
                <div class="pull-right-btn">
                    ...
                    <?php echo anchor("$controller_name/view/-1/",
                                      ...
                                      array('class' => 'btn btn-primary', 'title' => lang($controller_name . '_new')));
                    ?>
                    <?php endif ?>
