<?php 
class BizTaskUser extends CI_Model{
	...
	public function listItem($arrParam = null, $options = null){
		...
		if($options == null) {
			$this->db-> select("e.id, e.username AS name, CONCAT_WS(' ',p.first_name,p.last_name) AS fullname,el.location_id")
					 -> from($this->_table . ' AS e')
