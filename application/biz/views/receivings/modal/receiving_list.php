    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="panel-body nopadding table_holder table-responsive">
                <table class="tablesorter table table-hover data-n9-table" data-table="receiving_modal" data-scroll="false" data-url="<?php echo base_url() . 'receivings/modal_store/'; ?>" data-currentpage="<?php echo $current_page; ?>">
                    <thead>
                    <tr>
