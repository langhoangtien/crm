		...
		<div class="row manage-table">
			<div class="panel panel-piluku">
				<div class="panel-heading">
					<h3 class="panel-title hidden-print">Danh sách yêu cầu chuyển kho</h3>
				</div>
					...
					?>
						<tr rec_id="<?php echo $transfering['receiving_id'];?>">
							...
							<td class="status">
								...
								<button style="float: left;" type="button" class="btn btn-success btn_approve"><?php echo lang('common_waiting_approve'); ?></button>
...
var TRANSFER_PENDING = {
	...
	clickEventOnApproveBtn : function()
	{
		$('#dTableA tbody').on('click', 'td .btn_approve', function(){
			$('#dTableA tr').removeClass('row-selected');
			var _data = {};
			_data['obj_id'] = $(this).closest('tr').find('input[name="rec_id"]').val();
			_data['step_code'] = 'chuyen_kho';
			coreAjax.call(
