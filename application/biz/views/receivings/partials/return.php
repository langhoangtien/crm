...
<div id="pdf_content">
	...
	<div id="pdf_customer">
		<p>Họ tên nhà cung cấp: <?php if ($supplier) { ?> <span><?php echo $supplier; ?></span> <?php } ?></p>
		...
		<table id="pdf_tbl_items" class="w100 table">
			<tbody>
				...
				<?php foreach($payments as $payment_id => $payment) {
                    //sale_has_partial_credit_card_payment()

                                    ?>
				<tr>
                                    <td colspan="8" class="border-top border-bottom text-bold"><?php if (($is_integrated_credit_sale || 1) && ($payment['payment_type'] == lang('common_credit') ||  $payment['payment_type'] == lang('sales_partial_credit'))) { ?>
