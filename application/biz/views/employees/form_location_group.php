<?php
    $btn_submit = '<a href="javascript:;" onclick="save_commission_from_location_group();" class="btn btn-primary btn-send">Lưu</a>';
?>
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title">Cập nhập hoa hồng</h4>
        </div>
        <div class="modal-body">
            <form method="POST" name="commission_location_group_form" id="commission_location_group_form" class="form-horizontal" enctype="multipart/form-data">
