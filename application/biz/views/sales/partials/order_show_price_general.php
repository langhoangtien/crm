					...
					foreach($itemsContainsLine as $itemContainLine) {
                        ...
                        foreach ($itemContainLine['line'] as $line1) {
							foreach($cart as $line => $item) {
								if($line1 == $line && ($item['item_category_id'] != $dongco_dieukhien  && $item['item_category_id'] != 179)) {
                            ...
                            <tr>
                                <td class ="text-center"><?php echo $stt; ?></td>
                                <td class ="text-left"><?php echo $itemGeneralName; ?></td>
                                <td><?php echo to_quantity(abs($itemGeneralQuantity)); ?></td>
                                <td><?php echo NumberFormatToCurrency($itemGeneralTotal/$itemGeneralQuantity); ?></td>
                                <td><?php echo NumberFormatToCurrency($itemGeneralTotal); ?></td>
                            </tr>
                            <?php endif;?>
                        <?php
						foreach ($itemContainLine['line'] as $line1) {
