...
<style type="text/css">
 ...
 <div id="pdf_content">
		...
		<div>
			...
			<div id="pdf_company">
                ...
                <div class="fr w150px">
                        ...
                        <p>Số: <span><?php echo $sale_id; ?></span> &nbsp &nbsp &nbsp <?php echo lang('common_time').':'?> <span><?php echo date(get_time_format().' '.get_date_format(), strtotime($transaction_time)); ?></span>  </p>
	...
	<div id="pdf_title" class="clb">
     ...
     <div>
<?php if($customer): ?>
         <p>Khách hàng : <?php echo $customer; ?></p>
<?php endif; ?>
				 <p><?php echo lang('common_cashier').': ';echo $user_info->first_name." ".$user_info->last_name; ?></p>
         <p><?php echo lang('common_sale_person').': ';echo $sale_person; ?></p>
	...
	<div class="w100 clb">
			...
			<tbody>
				...
				<?php if ($amount_change >= 0) {?>
					<tr>
						<td colspan="8" class="border-top border-bottom text-bold"><?php echo 'Số tiền dư: ';
