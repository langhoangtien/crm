					...
					<tbody class="register-item-content">
						<?php foreach($items_counted as $counted_item) { ?>
							<tr class="register-item-details">
								...
								<td><a data-item-url="<?php echo base_url();?>/home/view_item_modal/<?php echo $counted_item['item_id']; ?>" data-toggle="modal" class=" item-name count-items" data-target="#itemsModal"><?php echo H($counted_item['name']).' ('.H($counted_item['category']).')'; ?></a></td>
