			...
			<div class="buttons-list">
				<div class="pull-right-btn">
					...
					if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) {
						...
						<a href="javascript:;" onclick="add_sms_template();" id="new-person-btn" class="btn btn-primary btn-lg" title="Thêm mới sms"><span class=""><?php echo lang('customers_add_new') ?></span></a>
				...
				<table class="tablesorter table table-hover" id="sortable_table">
					<thead>
						<tr>
							...
							<th><?php echo lang('customers_title') ?></th>
							<th><?php echo lang('customers_receiver') ?></th>
							<th></th>
						</tr>
					</thead>
					<tbody>
