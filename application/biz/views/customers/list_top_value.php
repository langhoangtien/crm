...
<!--                <a href="--><?php //echo base_url().'customers/categories'; ?><!--" id="mange_category" class="btn btn-primary" title="Thêm mới" style="background-color: #337ab7!important;"><span class="">--><?php //echo lang('customers_mange_category'); ?><!--</span></a>-->
...
<!--                    <button type="button" class="btn btn-more dropdown-toggle dropdown-menu-right" data-toggle="dropdown" aria-expanded="false" style="background-color: #337ab7!important;">-->
        ...
        <div class="row manage-table">
            <div class="panel panel-piluku">
                ...
                <div class="panel-body nopadding table_holder table-responsive" >
                    ...
                    <table id="tbl_customer" class="tablesorter table table-hover data-n9-table"  data-callback="true" data-table="customer_list" data-url="<?php echo base_url() . 'customers/list_top_customer_value/topContractValue/' ?>" data-currentPage="<?php echo $currrent_page; ?>">
                        <thead>
                        <tr>
                            <th class="leftmost" style="width: 10%; text-align: left;">
                                <?php echo lang('customers_no');?></label>
                            </th>
                            <th data-field="last_name" style="width: 30%;text-align: left;"<?php if($field_sort == 'last_name') echo ' class="text-left '.$class_sort.'"'; ?>><?php echo lang('common_customers_name'); ?></th>
                            <th style="width: 30%;text-align: left;"><?php echo lang('customers_contract'); ?></th>
                            <th style="width: 30%;text-align: left;"><?php echo lang('customers_contract_value'); ?></th>
                    ...
                    <?php }else{?>
                        <table id="tbl_customer" class="tablesorter table table-hover data-n9-table"  data-callback="true" data-table="customer_list" data-url="<?php echo base_url() . 'customers/list_top_customer_value/topAllContractValue/' ?>" data-currentPage="<?php echo $currrent_page; ?>">
                            <thead>
                            <tr>
                                <th class="leftmost" style="width: 10%; text-align: left;">
                                    <?php echo lang('customers_no');?></label>
                                ...
                                <th data-field="last_name" style="width: 30%;text-align: left;"<?php if($field_sort == 'last_name') echo ' class="text-left '.$class_sort.'"'; ?>><?php echo lang('common_customers_name'); ?></th>
                                <th style="width: 30%;text-align: left;"><?php echo lang('customers_num_of_sign_contract'); ?></th>
                                <th style="width: 30%;text-align: left;"><?php echo lang('customers_contract_value'); ?></th>
