	...
	<div class="modal-content customer-recent-sales">
		...
		<div class="modal-body ">
			<div class="row" id="form">
				...
				<div class="col-md-12">
					<?php 
						echo form_open('customers/do_send_sms_list',array('id'=>'send_sms_form','class'=>'form-horizontal'));
					?>
    ...
    $('#send_sms_form').validate({
        submitHandler:function(form)
        {
            ...
            $(form).ajaxSubmit({
                ...
                {
                    submitting = false;
                    show_feedback('success',response.message, <?php echo json_encode(lang('Gửi sms thành công')); ?>);
                    if (!response.success){
                    	window.location = <?php echo json_encode(site_url('customers/index?send_all=1')); ?>;
                    } 
                },
            });
        },
