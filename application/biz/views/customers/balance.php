...
$customer_type     = isset($filter['customer_type'])?$filter['customer_type']:'';
$employee_id       = isset($filter['employee_id'])?$filter['employee_id']:'';
...
?>
    <div class="manage_buttons">
        <div class="manage-row-options hidden" data-table="customer_balance_list">
            <div class="email_buttons text-center">
                ...
                <a href="javascript:;" data-table="customer_balance_list" data-url="<?php echo base_url() . 'customers/deletes'; ?>" class="btn btn-red btn-lg"><?php echo lang('common_delete'); ?></a>
                <?php } ?>
            </div>
        </div>
        <div class="row">
                ...
                <div class="search search-items no-left-border">
                        <ul class="list-inline">
                            <li>
                                ...
                                <input type="hidden" name="s_keywords" class="data-n9-s" data-table="customer_balance_list" value="<?php echo $keywords;?>" />
                            </li>
                            <li>
                                <select name="s_employee_id" class="form-control data-n9-s" data-table="customer_balance_list" id="s_employee_id">
                            ...
                            ?>
                             ...
                             <li>
                                <select name="s_type" class="form-control data-n9-s" data-table="customer_balance_list" id="s_type">
                                     <option value="balance"<?php if($filter['type'] == 'balance') echo ' selected'; ?>><?php echo lang('customers_receivables'); ?></option>
                                    <option value="balance_2"<?php if($filter['type'] == 'balance_2') echo ' selected'; ?>><?php echo lang('customers_payables'); ?></option>
                                </select>
                            <!--test -->
                            <li>
                                <select name="s_category_id" class="form-control data-n9-s" data-table="customer_balance_list" id="s_category_id">
                            ...
                            <!--danh mục con -->
                            <li>
                                <select name="s_category_child" class="form-control data-n9-s" data-table="customer_balance_list" id="s_category_child">
    ...
    <div class="container-fluid">
        <div class="row manage-table">
            <div class="panel panel-piluku">
                <div class="panel-heading">
                    <h3 class="panel-title">
                      <span class="title"><a href="<?php echo $link_list; ?>"><?php echo lang('common_list'); ?></a></span>
                        <span class="badge bg-primary tip-left" id="count_list">0</span>
                        ...
                        <span class="title first active"><?php echo lang('common_balance'); ?></span>
                        <span class="badge bg-primary tip-left" id="count_customer_balance_list">..</span>
                        ...
                        <span class="title"><a href="<?php echo $link_da_ky_hop_dong; ?>"><?php echo 'Đã ký hợp đồng'; ?></a></span>
                ...
                <div class="panel-body nopadding table_holder table-responsive" >
                    <table id="tbl_customer" class="tablesorter table table-hover data-n9-table" data-callback="true" data-table="customer_balance_list" data-url="<?php echo base_url() . 'customers/balance_list_store/' ?>" data-currentPage="<?php echo $currrent_page; ?>">
                        <thead>
                        <tr>
                        ...
                        <?php if(!empty($filter['type'])&& $filter['type'] == 'balance'): ?>
                            <th data-field="balance" style="width: 15%;text-align: left;"<?php if($field_sort == 'balance') echo ' class="header '.$class_sort.'"'; ?>><?php echo lang('customers_receivables'); ?></th>
                        <?php endif; ?>
                        
                        <?php if(!empty($filter['type'])&& $filter['type'] == 'balance_2'): ?>
                            <th data-field="balance_2" style="width: 15%;text-align: left;"<?php if($field_sort == 'balance_2') echo ' class="header '.$class_sort.'"'; ?>><?php echo lang('customers_payables'); ?></th>
                        <?php endif; ?>                   
            ...
            <div class="text-center data-n9-pagination" data-table="customer_balance_list"></div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            load_list('customer_balance_list');
            ...
            function startSearch () {
                load_list('customer_balance_list', 1);
            }
            ...
            $('body').on('change','#s_type',function(){
                load_list('customer_balance_list', 1);
            });
        });
