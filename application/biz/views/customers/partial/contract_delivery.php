<div class="panel-body nopadding table_holder table-responsive tabs" id="contract_delivery"<?php echo $display_css; ?>>
    <div class="clearfix top-control">
        ...
        <div class="col-xs-6 pull-right">
            <input type="button" value="Xóa" class="btn btn-red btn-lg btn-right" data-table="contract_delivery" data-url="<?php echo base_url() . 'contract/contract_delivery_delete' ?>" />
        </div>
...
?>
    <table class="tablesorter table table-hover data-n9-table" data-table="contract_delivery" data-url="<?php echo base_url() . 'customers/contract_delivery_store/' ?>" data-currentPage="1">
        <thead>
        <tr>
            <th class="leftmost" style="width: 20px;">
                <input type="checkbox"><label for="select_all" class="check_tatca"><span></span></label>
