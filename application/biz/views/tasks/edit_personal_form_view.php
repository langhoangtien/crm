    ...
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title">Sửa Công việc không tạo doanh thu </h4>
            <?php } else{?>
            ...
            <div class="toolbars">
                <ul class="list clearfix">
                    <?php if($type=="norevenue"){ ?>
                        <li class="btn-save"><a href="javascript:;" onclick="save_norevenue_task();"><i class="fa fa-floppy-o"></i>Lưu</a></li>
                    <?php } else { ?>
                        <li class="btn-save"><a href="javascript:;" onclick="save_personal_task();"><i class="fa fa-floppy-o"></i>Lưu</a></li>
                    <?php } ?>
            ...
            <div class="modal-body">
                <form method="POST" name="task_form" id="task_form" class="form-horizontal">
                    <div class="tabs" id="basic_manager" style="display: block;">
                        <div class="clearfix hang" style="margin-bottom: 10px;">
                            ...
                            <div class="col-lg-6" style="padding-right: 10px">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-8">
                                        <input type="text" name="date_start" id="date_start" class="form-control datepicker" value="<?php echo $date_start; ?>"/>
                            ...
                            <div class="col-lg-6" style="padding-left: 10px;">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-8">
                                        <input type="text" name="date_end" id="date_end" class="form-control datepicker" value="<?php echo $date_end; ?>" />
                            ...
                            <div class="col-lg-6 hide" style="padding-right: 10px">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-8">
                                        <select name="trangthai" class="form-control">
                                            ...
                                            foreach($trangthai_arr as $key => $val) {
                                                ?>
                                                <option <?php if($key == $trangthai) echo "selected"; ?> value="<?php echo $key; ?>"><?php echo $val; ?></option>
                                                <?php
                                            }
                                            ?>
                            ...
                            <div class="col-lg-6 hide" style="padding-left: 10px">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 hide">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-10">
                                       <input type="number" min="0" max="100" name="progress" value="<?php echo $progress ?>"  class="form-control"/>
                        ...
                        <?php if($type=="norevenue"){ ?>
                            ...
                            <!-- Nếu là công việc không doanh thu -->
                            <input type="hidden" name="type" value="norevenue">
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <select name="approved" id="" class="form-control">
                                            ...
                                            <?php foreach ($employees as $value) { ?>
                                                <option <?php if($item['approved']==$value['id']) echo "selected"; ?> value="<?php echo $value['id'] ?>"><?php echo $value['username'] ?></option>
                                            <?php  } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-lg-10">
                                        <div class="x-select-users" x-name="join" id="join_list" x-title="Người tham gia" style="display: inline-block; width: 100%;" onclick="foucs(this);">
                                            <?php
                                            if(!empty($item['joins'])) {
                                                foreach($item['joins'] as $key => $val) {
                                                    $user_id   = $val['id'];
                                                    $user_name = $val['username'];
                                                    ?>
                                                    <span class="item"><input type="hidden" name="join[]" class="join" id="join_<?php echo $user_id; ?>" value="<?php echo $user_id; ?>"><a><?php echo $user_name; ?></a>&nbsp;&nbsp;<span class="x" onclick="delete_item(this);"></span></span>
                        ...
                        <div class="pull-right">
                            <div class="buttons-list">
                                <div class="pull-right-btn">
                                    <a href="javascript:;" id="new-person-btn" onclick="add_personal_tiendo();" class="btn btn-primary" title="Thêm mới tiến độ"><span class="">Thêm mới tiến độ</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="manage-table manage-table-file tabs" id="file_manager">
                    <div class="manage-row-options 2 hidden" data-table="file-personal">
                        <div class="control">
                            <a href="javascript:;" class="btn btn-red delete_inactive" title="Sửa" onclick="edit_personal_file();"><span class="">Sửa</span></a>
                    ...
                    <div class="control clearfix">
                        <div class="pull-right">
                            <div class="buttons-list">
                                <div class="pull-right-btn">
                                    <a href="javascript:;" id="new-person-btn" onclick="add_personal_file();" class="btn btn-primary" title="Thêm mới tiến độ"><span class="">Thêm mới File</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="manage-table tabs" id="detail_manager" style="margin-top: -10px;">
                    <table width="100%" cellpadding="7" class="x-info" style="border:0">
                        <tbody>
                            ...
                            <tr>
                                <td class="x-info-label">Phê duyệt</td>
                                <td class="x-info-content" colspan="3"><?php if($item['pheduyet']==1){echo "Đã phê duyệt";}else {echo "Chờ phê duyệt";} ?></td>
                            </tr>
                            <tr>
...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true" class="x-close">×</span></button>
            <h4 class="modal-title">Công việc Cá nhân </h4>
        </div>
        <div class="modal-body">
            <div class="manage-table" id="detail_manager" style="margin-top: -10px;">
                <table width="100%" cellpadding="7" class="x-info" style="border:0">
                    <tbody>
                    <tr>
                        <td class="x-info-top" colspan="4" style="padding-left: 5px; padding-right: 10px; font-size: 16px; border: 0 !important;">
