                    ...
                    <div class="search no-left-border">
                        ...
                        <select class="form-control" id="employee_id">
                        	<?php foreach ($employees as $id => $employee) {
                        	    $selected = '';
                        	    if ($this->Employee->get_logged_in_employee_info()->id == $id) {
                        	        $selected = 'selected="selected"';
                        	    }
                        	?>
                            <option value="<?php echo $id; ?>" <?php echo $selected;?>><?php echo $employee;?></option>
                            <?php } ?>
                        </select>
            ...
            <div class="panel panel-piluku">
                <div class="gantt_title">
                    <h3 class="panel-title">                      
                        ...
                        <span class="tieude active">Công việc liên quan</span>
                    ...
                    <div class="table-responsive">
                        <table class="table tablesorter table-reports table-bordered table-tree" id="project_grid_table" data-table="task_list">
                            ...
                            <tr align="center" style="font-weight:bold">
                                ...
                                <th align="center" data-field="last_name">KH liên quan</th>
                                <th align="center" data-field="last_name">Dự án liên quan</th>
                                <th align="center" data-field="prioty">Ưu tiên</th>
                                <th align="center" data-field="date_start">Ngày bắt đầu</th>
                                <th align="center" data-field="date_finish">Ngày phê duyệt hoàn thành</th>
                                <!-- <th align="center" style="width: 275px;" data-field="progress">Tiến độ</th> -->
                                <th align="center" data-field="trangthai">Tình trạng</th>
                                <th align="center">Người phụ trách</th>
                                 <th align="center">Người tham gia</th>
                    ...
                    <form class="form-horizontal form-horizontal-mobiles">
                        ...
                        <div class="form-group" style="margin-bottom: 5px;">
                            <div class="form-actions pull-right">
                                <input type="button" name="submitf" value="Thực hiện" id="btn_search_advance_task_list" style="margin-right: 16px;" class=" submit_button btn btn-primary">
                            </div>
                        </div>
                    </form>
                </div>
