...
<style>
    ...
    <div class="manage_buttons">
        <div class="manage-row-options hidden" data-table="norevenue">
            <div class="email_buttons text-center">
                <a href="javascript:;" class="btn btn-red " title="Xóa" onclick="delete_norevenue();"><span class="btn btn-primary">Xóa</span></a>
            </div>
        </div>
        <div class="cl">
            <div class="pull-left">
                <div action="" id="search_form" autocomplete="off" class="form-inline" method="post" accept-charset="utf-8">
                    <div class="search no-left-border">
                        ...
                        <select class="form-control" id="search_date_type_no">
                     ...
                     <!--    <button name="statistic" class="btn btn-primary  statistic" id="btn_statistic">Thống kê</button>
                        <button name="btn_advance_task" id="btn_advance_task" class="btn btn-primary ">Nâng cao</button> -->
            ...
            <div class="pull-right">
                <div class="buttons-list">
                    <div class="pull-right-btn">
                        <a href="javascript:;" onclick="update_personal_task('new', 'norevenue');" class="btn btn-primary " title="Thêm mới"><span class="">Thêm mới</span></a>
                        <a href="<?php echo base_url('tasks/norevenue_log') ?>"  class="btn btn-primary " title="Thêm mới"><span class="">LOG</span></a>
            ...
            <div class="panel panel-piluku">
                 ...
                 <div class="gantt_title">
                    <h3 class="panel-title">
                        ...
                        <span class="tieude"><a href="<?php echo base_url() . 'tasks/task_chart'; ?>">Lược đồ</a></span>
                         ...
                         <span class="tieude active">Công việc không tạo doanh thu</span>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table tablesorter table-reports table-bordered table-tree" id="project_grid_table" data-table="norevenue">
                            <thead>
                            <tr align="center" style="font-weight:bold">
                                ...
                                <th align="center" style="" data-field="date_start">Ngày bắt đầu</th>
                                <th align="center" style="" data-field="date_end">Ngày cần hoàn thành</th>
                                <th align="center" data-field="join">Người tham gia</th>
                                <th align="center" data-field="implement">Người phụ trách</th>
                                <th align="center" data-field="">Người phê duyệt</th>
                                <th align="center" style="" data-field="trangthai">Tình trạng</th>
                                <th align="center" style="" data-field="note">Mô tả</th>
