					...
					foreach ($items as $val) {
						...
						<tr>
							...
							<td class="right"><a href="javascript:;"
								data-id="<?php echo $id; ?>"
								data-child="<?php echo $child_ids; ?>"
								onclick="del_template_task(this);">Xóa</a></td>
							</tr>
							<?php
						}
					} else {
						?>
						<tr>
							<td colspan="2"><div class="col-log-12"
								style="text-align: center; color: #efcb41;">Không có dữ liệu hiển thị</div></td>
							</tr>
							<?php
						}
						?>
