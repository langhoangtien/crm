<?php 
	...
	$trangthai_arr = array('Chưa thực hiện', 'Đang thực hiện', 'Hoàn thành');
                ...
                <div class="tabs" id="basic_manager" style="display: block;">
                    <div class="clearfix hang" style="margin-bottom: 10px;">
                        ...
                        <div class="col-lg-12 hide">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-lg-10">
                                    <select  name="task_template" id="task_template" class="form-control hide" id="timezone">
                    ...
                    <div class="clearfix hang">
                        <div id="add_navigation">
                                    ...
                                    <div class="col-lg-6" style="padding-right: 10px">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-lg-8">
                                                <input type="text" name="date_start" id="date_start" value="<?php echo date("d-m-Y") ?>" class="form-control datepicker" />
                            ...
                            <?php if($is_create_task == true):?>
                                <div class="title hide" data-id="permission_content">Cấp quyền</div>
                                <div id="permission_content" class="content">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="col-md-3 col-lg-2 control-label">Cập nhật CV con</label>
                                                <div class="col-md-9 col-lg-10">
