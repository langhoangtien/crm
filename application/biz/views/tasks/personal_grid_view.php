    ...
    <div class="manage_buttons">
        <div class="manage-row-options hidden" data-table="personal">
            <div class="email_buttons text-center">
                <a href="javascript:;" class="btn btn-red btn-primary " title="Xóa" onclick="delete_personal();"><span class="">Xóa lựa chọn</span></a>
            </div>
        </div>
        <div class="cl">
            <div class="pull-left">
            ...
            <div class="pull-right">
                <div class="buttons-list">
                    <div class="pull-right-btn">
                        <a href="javascript:;" onclick="update_personal_task('new', 'personal');" class="btn btn-primary " title="Thêm mới"><span class="">Thêm mới</span></a>
            ...
            <div class="panel panel-piluku">
                 <div class="gantt_title">
                    <h3 class="panel-title">
                        ...
                        <span class="tieude active">Ghi chép</span>
                ...
                <div class="panel-heading" style="border: 0; padding-left: 0;">
                    <div class="gantt_title">
                        <button class="btn btn-primary">Cá nhân</button>
                        <a href="<?php echo base_url()?>calendars" class="btn btn-primary">Calendar</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table tablesorter table-reports table-bordered table-tree" id="project_grid_table" data-table="personal">
                            ...
                            <tr align="center" style="font-weight:bold">
                                ...
                                <th align="center" style="width: 150px;" data-field="date_start">Bắt đầu</th>
                                <th align="center" style="width: 150px;" data-field="date_end">Kết thúc</th>
