...
<div class="manage-row-options">
	<div class="email_buttons text-center">		
		<a href="javascript:;" class="btn btn-red btn-primary" title="Xóa" onclick="delete_project();"><span class="">Xóa</span></a>		
	</div>
</div>
<div class="cl">
	<div class="pull-left">
	...
	<div class="pull-right">
		<div class="buttons-list" style="padding-top: 0;">
			<div class="pull-right-btn">
				<a href="javascript:;" onclick="add_project();" class="btn btn-primary " title="Thêm mới Template"><span class="">Thêm mới Dự án</span></a>					
			</div>
		</div>				
	</div>
    <div class="cl"></div>
