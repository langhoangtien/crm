...
<div class="modal-dialog modal-lg" role="document">
	...
	<div class="modal-body">
		<ul class="nav nav-tabs">
			<?php if($pheduyet != 0): ?>
				<li role="presentation" class="active"><a data-toggle="tab" href="#basic_manager">Cơ bản</a></li>
			<?php endif; ?>

			<?php if($pheduyet == 1 || $pheduyet == 2): ?>
				<li role="presentation"><a data-toggle="tab" href="#progress_manager">Tiến độ</a></li>
			<?php endif; ?>
			<?php if($pheduyet != 0): ?>
				<li role="presentation"><a data-toggle="tab" href="#file_manager">Tài liệu</a></li>
			<?php endif; ?>
			<?php if($pheduyet != 0): ?>
				<li role="presentation"><a data-toggle="tab" href="#tranfer-manager">Chuyển công việc</a></li>
			<?php endif; ?>
			<?php if($parent==0){ ?><li role="presentation"><a data-toggle="tab" href="#supplier_manager">Bên thứ 3</a></li><?php } ?>
			<li role="presentation"><a data-toggle="tab" href="#detail_manager">Chi tiết</a></li>
			<?php if($parent==0){ ?> <li role="presentation"><a data-toggle="tab" href="#workload">Tỷ trọng công việc</a></li><?php } ?>
		</ul>
		<form method="POST" name="task_form" id="task_form" class="form-horizontal">
			<div class="tab-content" style="max-height: 700px; overflow-y: auto;">
				...
				<div class="tab-pane fade in active" id="basic_manager">
				...
				<!-- Phê duyệt -->
				<?php if($pheduyet == 1 || $pheduyet == 2): ?>
					<div class="tab-pane fade" id="progress_manager">
								...
								<tbody>
									<?php $i=1; foreach ($progress_list as $key => $value) { ?>
										<tr>
											...
											<td><?php echo round($value['progress'],2) ?></td>
						...
						<tbody>
							...
							<?php $i=1;foreach ($child as $key => $value) {
								...
								<tr>
									...
									<td><div class="form-group col-md-6"><input value="<?php echo $value['percent'] ?>" name="workload_list" class="workload_list" class="form-control" type="text"></div>
									</td>
								</tr>
							<?php } ?>
							<tr>
								...
								<td><input value="Cập nhật tỷ trọng"class="btn hehe btn-primary" type="button"></td>
