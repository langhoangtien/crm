			...
			<div class="panel panel-piluku">
				...
				<div style="min-height: 410px;" class="panel-body nopadding table_holder table-responsive">
					<div class="col-md-12" style="padding-top: 20px;">
						<?php 
							echo form_open('stock_in/history', array('method'=>'get', 'class' => 'form_receipt_suspended_recv'));
						?>
								<div class="col-md-3">
					...
					?>
						<tr rec_id="<?php echo $row['id'];?>">
							<input type="hidden" name="stock_in_id" value="<?php echo $row['id'];?>" />
							...
							<td>
								<a href="<?php echo site_url("stock_in/pre_print/" . $row['id'])?>" class="btn btn-primary btn-lg"><?php echo lang('common_recp'); ?></a>
							</td>
						</tr>
					<?php
					}
