...
$current_person_id = $_SESSION['person_id'];
if($current_person_id == 1)
    $style_admin_section = ' style="display: block;"';
else
    $style_admin_section = ' style="display: none;"';
		...
		<!-- Css Loader  -->
			...
			<div class="buttons-list config-page">
				...
				<div class="pull-right-btn">
					<?php if($this->Employee->has_module_permission('sync_offline', $this->Employee->get_logged_in_employee_info()->person_id, false)) {
						echo anchor('sync_offline', 'Đồng bộ dữ liệu', array('class' => 'btn btn-primary btn-lg dbSync'));
					} ?>
...
<div class="config-panel">
	<div class="row">
		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				<div class="panel-heading">
					Thông báo sắp đến hạn công việc
				</div>
				<div class="panel-body">
						<div class="form-group">
						<?php echo form_label('Thời gian thông báo :', 'alert_time',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
						<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'alert_time',
							'id'=>'alert_time',
							'value'=>$this->config->item('alert_time')));?>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-md-12 hide">
	        ...
	        <div class="form-group">
					<?php echo form_label(lang('common_default_receiving_VAT').' :', 'default_receiving_VAT_',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-4 col-md-4 col-lg-5">
								<?php echo form_input(array(
								'class'=>'form-control form-inps',
								'name'=>'default_receiving_VAT_name',
								'placeholder' => lang('common_tax_name'),
								'id'=>'default_receiving_VAT_name',
								'size'=>'10',
								'value'=>$this->config->item('default_receiving_VAT_name')!==NULL ? $this->config->item('default_receiving_VAT_name') : 'VAT'));?>
						</div>
							<div class="col-sm-4 col-md-4 col-lg-5">
							<?php echo form_input(array(
							'class'=>'form-control form-inps-tax',
							'placeholder' => lang('common_tax_percent'),
							'name'=>'default_receiving_VAT',
							'id'=>'default_receiving_VAT',
							'size'=>'4',
							'value'=>$this->config->item('default_receiving_VAT')));?>
		...
		<div class="col-md-12 hide">
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
                        <?php echo form_label('Tên TK khách nợ :', 'customer_balance',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                'class'=>'form-control form-inps',
                    ...
                    <div class="form-group">
                        <?php echo form_label('Tên TK nợ khách :', 'customer_balance_2',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                'class'=>'form-control form-inps',
                    ...
                    <div class="form-group">
                        <?php echo form_label('Tên TK nợ NCC :', 'supplier_balance',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                'class'=>'form-control form-inps',
                    ...
                    <div class="form-group">
                        <?php echo form_label('Tên TK NCC nợ :', 'supplier_balance_2',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                'class'=>'form-control form-inps',
                    ...
                    <div class="form-group">
                        <?php echo form_label('Hóa đơn bán hàng có dịch vụ :', 'sale_order_has_service',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_checkbox(array(
                                'name'=>'sale_order_has_service',
                                'id'=>'sale_order_has_service',
                                'value'=>'1',
                                'checked'=>$this->config->item('sale_order_has_service')));?>
                            <label for="sale_order_has_service"><span></span></label>
                        </div>
                    </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							<a href="#" class="btn btn-primary payment_types"><?php echo lang('common_debt_customer'); ?></a>
							<a href="#" class="btn btn-primary payment_types"><?php echo lang('common_debt_supplier'); ?></a>
							<br>
							<br>
							<?php echo form_input(array(
								'class'=>'form-control form-inps',
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_dropdown('default_sales_person', array('logged_in_employee' => lang('common_logged_in_employee'), 'not_set' => lang('common_not_set'), 'group_default'=>'Mặc định của nhóm bán hàng'), $this->config->item('default_sales_person'),'class="form-control" id="default_sales_person"'); ?>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							'class'=>'form-control',
							'value'=>(float)$this->config->item('commission_default_rate')));?>%
						</div>
					</div>
					...
					<div class="form-group">
						<?php echo form_label(lang('config_template_sale').' :', 'config_template_sale',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php
                    ...
                    <div class="form-group">
                        <?php echo form_label('Đơn đặt hàng :', 'config_template_order_sale',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php
                            $arr = array('0' 	=> 	lang('config_template_default'));
                            if(!empty($qc_types)) {
                    ...
                    <div class="form-group">
                        <?php echo form_label('Giá nhập hàng :', 'config_price_imported',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php
                    ...
                    <div class="form-group">
                        <?php echo form_label('SP có giá vốn bằng giá bán khi lập hóa đơn :', 'config_adjusted_cost_price',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                ...
                ?>
								...
								<div class="form-group">
								<?php echo form_label(lang('config_sales_add_more_cus_for_visa').': ', 'config_sales_add_more_cus_for_visa',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
									<div class="col-sm-9 col-md-9 col-lg-10">
									<?php echo form_checkbox(array(
										'name'=>'config_sales_add_more_cus_for_visa',
										'id'=>'config_sales_add_more_cus_for_visa',
										'value'=>'1',
										'checked'=>$this->config->item('sales_add_more_cus_for_visa')));?>
										<label for="config_sales_add_more_cus_for_visa"><span></span></label>
									</div>
								</div>
							</div>
			</div>
			...
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<?php echo form_label(lang('config_require_employee_login_before_each_sale').' :', 'require_employee_login_before_each_sale',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_checkbox(array(
							'name'=>'require_employee_login_before_each_sale_',
							'id'=>'require_employee_login_before_each_sale_',
...
//							'khmer' => 'Khmer',
					...
					<?php echo form_label(lang('config_default_new_items_to_service').' :', 'default_new_items_to_service',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                       ...
                       <div class="form-group">
						<?php echo form_label(lang('config_enable_customer_dashboard').' :', 'enable_customer_dashboard',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
								<div class="col-sm-9 col-md-9 col-lg-10">
									<?php echo form_checkbox(array(
									'name'=>'enable_customer_dashboard',
									'id'=>'enable_customer_dashboard',
									'value'=>'1',
									'checked'=>$this->config->item('enable_customer_dashboard')));?>
									<label for="enable_customer_dashboard"><span></span></label>
								</div>
						</div>
						...
						<?php echo form_label(lang('common_return_policy').' :', 'return_policy',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
                            ...
                            <span for="return_policy" class="text-danger errors"></span>
							</div>
						</div>
        ...
        <div class="col-md-12 hide">
            <div class="panel panel-piluku">
                <div class="panel-heading">
                    Lợi nhuận và hoa hồng
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <?php echo form_label('Tính hoa hồng khi:', 'commission_time_method',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    <div class="form-group">
                        <?php echo form_label('Tính theo:', 'commission_method',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    <div class="form-group">
                        <?php echo form_label('Tỷ suất tối thiểu :', 'min_profit',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label  required wide')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                'class'=>'valid form-control form-inps',
                                'type' => 'text',
                    ...
                    <div class="form-group" style="display: none;">
                        <?php echo form_label('Lợi nhuận tối thiểu để tính hoa hồng :', 'min_profit_commission',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label  required wide')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                'class'=>'valid form-control form-inps',
                                'type' => 'text',
...
<div class="hide">
        <div class="col-md-12 hide">
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <?php echo form_label('Người nhận :', 'shift_user_id',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_dropdown('shift_user_id',$employees, $this->config->item('shift_user_id') , 'id="shift_user_id" class=""'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <?php echo form_label('Số lượng :', 'import_quantity',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label  required wide')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
        ...
        <div class="col-md-12"<?php echo $style_admin_section; ?>>
            <div class="panel panel-piluku">
                <div class="panel-heading">
                    Admin Section
                </div>
                <div class="panel-body">
                    <div class="hide form-group">
                        <?php echo form_label('Hóa đơn VAT :', 'config_vat_order',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label  wide')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    <div class="form-group">
                        <?php echo form_label('Số lượng mặc định bán hàng :', 'config_default_sale_quantity',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                'class'=>'valid form-control form-inps',
                                'type' => 'text',
     ...
     <div class="col-md-12">
			<div class="panel panel-piluku">
				<div class="panel-heading">
					<?php echo lang('config_ecommerce_settings_info'); ?>
				</div>	
				<div class="panel-body">
            ...
            <div class="form-group ecom_settings" data-keyword="<?php echo H(lang('config_keyword_ecommerce')) ?>">	
            	<?php
            			...
            			<div class="form-group ecom_settings">
						<?php echo form_label(lang('config_ecommerce_cron_sync_operations').':', 'config_ecommerce_cron_sync_operations',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php
								$list_operations = [
							...
							?>
							<?php foreach ($list_operations as $operation) { ?>
							<div>
							<?php echo form_checkbox(array(
								'name'=> $operation,
								'id'=> $operation,
								'value'=> 1,
								'checked'=> in_array($operation, $ecommerce_cron_sync_operations)));?>
								<label for="<?php echo $operation; ?>"><span></span></label> <?php echo lang('config_' . $operation); ?>
							</div>
							<?php } ?>
						</div>
					</div>	
      ...
      <div class="col-md-12 woo_settings ecom_settings <?php echo $hidden_class; ?>">
			<div class="panel panel-piluku">
				<div class="panel-heading">
					<?php echo lang('config_woocommerce_settings_info'); ?>
				</div>
...
function CK_jQ() {
 ...
 function reset_form() {
        ...
        for (instance in CKEDITOR.instance) {
            CKEDITOR.instance[instance].setData('');
        }
    }
//validation and submit handling
$(document).ready(function()
{
	woo_ecommerce_behavior();
    $("#shift_user_id").select2();
    $( "#shift_category_id" ).change(function() {
        var category_id = $(this).val();
        if(category_id != 0) {
            $.ajax({
                type: "POST",
                url: BASE_URL + 'config/validate_child_category',
                data: {
                    category_id : category_id
                },
                success: function(string){
                    if(string == 'false') {
                        toastr.error('Không ???c ch?n danh m?c có danh m?c con!', 'C?nh báo');
                        $( "#shift_category_id" ).val('0');
                    }
                }
            });
        }
	...
	$(".checkForUpdate").click(function(event)
	{
		...
		$.getJSON($(this).attr('href'), function(update_available)
		{
			...
			if(update_available)
			{
				...
				window.location="http://lifetek.com.vn/versioncrm/";
			}
			else
			{
...
function frm_group_commission() {
    $.ajax({
        type: "POST",
        url: BASE_URL + 'ajax/frm_commission_group',
        data: {
        },
...
function check_ecommerce_status()
{
	if (wooSync) {
    	...
    	$.getJSON(SITE_URL+'/home/get_ecommerce_sync_progress', function(response)
    	{
    		...
    		setTimeout(check_ecommerce_status,500);
    	});
	} else {
...
function woo_ecommerce_behavior() {
	$("#sync_progress").hide();
	      ...
	      cancel: {
			...
			callback: function(response)
			{
				...
				{	
					...
					set_progress(0, <?php echo json_encode(lang('common_ecommerce_sync_cancel')); ?>);
					setTimeout(function(){
		...
		bootbox.confirm({
	      ...
	      cancel: {
			...
			callback: function(response)
			{
				...
				{	
					wooSync = 1;
					set_progress(0, <?php echo json_encode(lang('common_ecommerce_running')); ?>);
					...
					$("#config_form").ajaxSubmit(function(){
						...
						$.ajax(href, {
							...
							success: function(data) {
								...
								set_progress(100, <?php echo json_encode(lang('common_ecommerce_sync_finish')); ?>);
								setTimeout(function(){
									$("#sync_progress").toggleClass("hidden", true);
								}, 1000);
								wooSync = 0;
