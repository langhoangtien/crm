                ...
                <div class="panel-heading reports">
                   Báo cáo thu chi chi tiết khách hàng
                    ...
                    <input type="hidden" class="data-n9-s" name ='s_end_date' value="<?php if(isset($filter['end_date'])) echo $filter['end_date']; ?>" data-table="store_accounts"/>
                     <input type="hidden" class="data-n9-s" name="customer_id" value="<?php echo $filter['customer_id']; ?>" data-table="store_accounts"/>
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            <?php if($filter['customer_id'] == -1) :?>
                toastr.error('Bạn chưa chọn khách hàng', 'Lỗi');
            <?php endif; ?>
        });
