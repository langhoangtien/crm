...
<script type="text/javascript" language="javascript">
	$(document).ready(function()
	{
		...
		$("#generate_report").click(function(e)
		{
			...
			{
				window.location = 'reports/bao_cao_chi_tiet_xuat_nhap_ton_store'+'/'+$("#report_date_range_simple option:selected").val() + '/'+specific_id+'/'+show_manual_adjustments_only + '/' + export_excel;
			}
			else
			{
				...
				if (typeof start_date != 'undefined' &&  typeof end_date != 'undefined' &&  typeof specific_id != 'undefined') { 
					window.location = 'reports/bao_cao_chi_tiet_xuat_nhap_ton_store'+'/'+start_date + '/'+ end_date + '/'+ specific_id+'/'+show_manual_adjustments_only + '/' + export_excel;
				} else {
