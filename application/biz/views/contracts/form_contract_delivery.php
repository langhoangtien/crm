                            ...
                            <div class="col-lg-12">
                                <table class="tablesorter table table-hover data-n9-table" id="tbl_delivery_items">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 15%;">Còn lại/Tổng SL</th>
                                    ...
                                    if(!empty($items)) {
                                        foreach($items as $key => $item) {
                                            ...
                                            <tr style="cursor: pointer;">
                                                ...
                                                <td class="center cb"><span id="delivered_<?php echo $key; ?>" class="delivered_info"><?php echo (float)($item['limit']); ?>/<?php echo $quantity; ?></span></td>
                                                <td class="center">
