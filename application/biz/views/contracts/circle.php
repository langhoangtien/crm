...
<?php
$key_filter = 'contract_'.$option.'_circle_filter';
...
<div class="manage_buttons">
    <div class="manage-row-options hidden" data-table="pos_circle_contract">
        <div class="email_buttons text-center">
            <?php //if ($this->Employee->has_module_action_permission($controller_name, 'delete', $this->Employee->get_logged_in_employee_info()->person_id)) {?>
            <a href="javascript:;" data-table="pos_circle_contract" data-url="<?php echo base_url() . 'contracts/contract_delete'; ?>" class="btn btn-red btn-lg"><?php echo lang('common_clear_selection'); ?></a>
            <?php //} ?>
        </div>
    </div>
    <div class="row">
                ...
                <div class="search search-items no-left-border">
                    <ul class="list-inline">
                        <li>
                            ...
                            <input type="hidden" name="s_keywords" class="data-n9-s" data-table="pos_circle_contract" value="<?php echo $keywords;?>" />
                            <input type="hidden" name="s_option" class="data-n9-s" data-table="pos_circle_contract" value="<?php echo $option;?>" />
                        </li>
...
<div class="container-fluid">
    <div class="row manage-table">
        <div class="panel panel-piluku">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <span class="title active"><?php echo lang('contracts_service_cycle') ?></span>
                    <span class="badge bg-primary tip-left" id="count_pos_circle_contract">0</span>
                    <span class="title"><a href="<?php echo $link_expired; ?>"><?php echo lang('contracts_contract_expiration') ?></a></span>
                    <span class="badge bg-primary tip-left" id="count_pos_expired_contract"><?php echo $expired_count; ?></span>
                    <i class="fa fa-spinner fa-spin loading" id="pos_circle_contract_loading" style="display: none;"></i>
                </h3>
            </div>
            <div class="panel-body nopadding table_holder table-responsive" >
                <table class="tablesorter table table-hover data-n9-table" data-table="pos_circle_contract" data-url="<?php echo base_url() . 'contracts/contract_circle_store/' ?>" data-currentPage="<?php echo $currrent_page; ?>">
                    <thead>
                    <tr>
        ...
        <div class="text-center data-n9-pagination" data-table="pos_circle_contract"></div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function add_contract() {
        var page = $('table[data-table="pos_circle_contract"]').attr('data-currentPage');
        window.location.href = BASE_URL + 'contracts/view/<?php echo $option; ?>/-1/'+page+'/circle';

    }

    function edit_contract(id) {
        var page = $('table[data-table="pos_circle_contract"]').attr('data-currentPage');
        window.location.href = BASE_URL + 'contracts/view/<?php echo $option; ?>/'+id+'/'+page+'/circle';
    }

    function send_mail_contract(id) {
        var page = $('table[data-table="pos_circle_contract"]').attr('data-currentPage');
        var link_email = BASE_URL + 'contracts/email/'+option+'/'+id+'/'+page+'/circle';
    ...
    $( document ).ready(function() {
        ...
        function startSearch () {
            load_list('pos_circle_contract', 1);
        }
