            ...
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                    <div class="row" id="contract_section">
                        <?php $this->load->view('contracts/partial/'.$type.'_section');?>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6" style="padding-right: 5px;">
                                <div class="form-group hang">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-9">
                                        <input type="text" value="<?php echo $customer_fullname; ?>" id="customer_fullname" class="form-control" readonly="true">
                                    </div>
                                </div>
                                <div class="form-group hang">
                                    <label for="title" style="text-align: left;" class="wide col-sm-3 col-md-3 col-lg-3 control-label">Địa chỉ :</label>
                                    <div class="col-sm-9 col-md-9 col-lg-9">
                                        <input type="text" value="<?php echo $customer_address; ?>" id="customer_address" class="form-control" readonly="true" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6" style="padding-left: 5px;">
                                <div class="form-group hang">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-9">
                                        <input type="text" value="<?php echo $customer_company_name; ?>" id="customer_company_name" class="form-control" readonly="true" />
                                ...
                                <div class="form-group hang">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-9">
                                        <input type="text" value="<?php echo $customer_phone_number; ?>" id="customer_phone" class="form-control" readonly="true"/>
                                    </div>
                                </div>
                            </div>
                        </div>
