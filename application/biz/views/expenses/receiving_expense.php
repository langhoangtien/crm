		...
		<div class="panel panel-piluku">
			<div class="panel-heading">
				<h3 class="panel-title space_title">
					<span class="title" id="all_items"><a href="<?php echo $link_list ?>"><?php echo lang('expenses_internal_costs'); ?></a></span>
					<span class="badge bg-primary tip-left" id="count_in_expense">0</span>

					<span class="title" id="sale_expense"><a href="<?php echo $link_sale_expense ; ?>"><?php echo lang('expenses_cost_of_sale'); ?></a></span>
					<span class="badge bg-primary tip-left" id="count_sale_expense">0</span>

					<span class="title first active" id="receiving_expense"><?php echo lang('expenses_import_costs'); ?></span>
			...
			<table id="tbl_items" class="tablesorter table table-hover data-n9-table "  data-callback="true" data-table="expenses_list" data-url="<?php echo base_url() . 'expenses/receiving_store/' ?>" data-currentPage="<?php echo $current_page; ?>">
				<thead>
					<tr>
						...
						<th class="hr-lbl" data-field="id" style="text-align: left;"<?php if($field_sort == 'receiving_id') echo ' class="header '.$class_sort.'"'; ?>><?php echo lang('code_orders') ?></th>
						...
						<th class="hr-lbl" data-field="expense_description" style="text-align: left;width: 25%;"<?php if($field_sort == 'expense_description') echo ' class="header '.$class_sort.'"'; ?>><?php echo lang('expenses_description'); ?></th>
						...
						<th class="hr-lbl" data-field="expense_amount" style="text-align: left;"<?php if($field_sort == 'expense_amount') echo ' class="header '.$class_sort.'"'; ?>><?php echo lang('expenses_amount'); ?></th>
						<th class="hr-lbl" data-field="expense_tax" style="text-align: left;"<?php if($field_sort == 'expense_tax') echo ' class="header '.$class_sort.'"'; ?>><?php echo lang('expenses_tax'); ?></th>
						<th class="hr-lbl" data-field="company_name" style="text-align: left;"<?php if($field_sort == 'company_name') echo ' class="text-left '.$class_sort.'"'; ?>><?php echo lang('expenses_supplier'); ?></th>
						...
						<th class="hr-lbl" style="text-align: left;"><?php echo lang('expenses_update'); ?></th>
					</tr>
				</thead>
				<tbody>
...
<script type="text/javascript" >
	...
	function n9_grid_callback(data_table,result) {
		...
		$('#count_sale_expense').text(result.count_sale_expense);    
		$('#count_receiving_expense').text(result.count);                   
	}
</script>
