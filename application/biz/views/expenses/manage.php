		...
		<div class="panel panel-piluku">
			<div class="panel-heading">
				<h3 class="panel-title space_title">
					<span class="title first active" id="all_items">Chi phí chung</span>
					<span class="badge bg-primary tip-left" id="count_in_expense">0</span>

					<span class="title" id="sale_expense"><a href="<?php echo $link_sale_expense; ?>">Doanh thu chia cho phòng ban khác</a></span>
			...
			<table id="tbl_items" class="tablesorter table table-hover data-n9-table "  data-callback="true" data-table="expenses_list" data-url="<?php echo base_url().'expenses/list_store/' ?>" data-currentPage="<?php echo $current_page; ?>">
				<thead>
					<tr>
						...
						<th class="hr-lbl" data-field="expense_description" style="text-align: left;"<?php if($field_sort == 'expense_description') echo ' class="header '.$class_sort.'"'; ?>><?php echo lang('Mô tả'); ?></th>
...
<script type="text/javascript" >
	...
	function n9_grid_callback(data_table,result) {
		$('#count_in_expense').text(result.count);
