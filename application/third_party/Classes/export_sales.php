...
$this->excel->getActiveSheet()->setCellValue('D8','"'.$this->config->item('code_taxe').'"') ;
$this->excel->getActiveSheet()->getStyle('D8')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
//$this->excel->getActiveSheet()->getStyle('D8')
//    ->getNumberFormat()
...
//$a=$this->config->item('corp_number_account');
//$b= (string)$a;
$this->excel->getActiveSheet()->setCellValue('D11','"'.$this->config->item('corp_number_account').'"');
...
$this->excel->getActiveSheet()->setCellValue('F12',$this->config->item('corp_bank_name'));
...
$this->excel->getActiveSheet()->setCellValue('D14',' Ông/bà: '.mb_convert_case($data['customer'],MB_CASE_UPPER, "UTF-8"));
