...
$this->excel->getActiveSheet()->setCellValue('B'.($i+10),"
	Tài khoản công ty:
...
$this->excel->getActiveSheet()->setCellValue('A'.($i+12),"ĐẠI DIỆN NHÀ CUNG CẤP");
...
$filename = 'bangbaogia.xlsx'; //save our workbook as this file name
//$filename = 'Book1.xlsx';
